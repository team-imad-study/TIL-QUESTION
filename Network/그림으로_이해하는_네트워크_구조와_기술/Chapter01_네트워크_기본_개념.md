...
## Q1. WWW 은 무엇의 줄임말 일까요?
WORLD WIDE WEB 의 줄임말으로써
1989년에 유럽의 입자물리연구소에서 팀버너스리가 정보
공유수단으로써 사용하였다. 인터넷과는 완전히 별도의 장
소에서 생겨났지만 나중에 인터넷과 결합되면서 정보공유
수단으로써 활용되었음

## Q2. LAN 과 WAN 의 원줄임말과 정의적 차이는??
LAN = LOCAL AREA NETWORK
WAN = WIDE AREA NETWORK
랜은 하나의 거점 내부를 연결하는 네트워크이며
왠은 거점과 거점 또는 거점과 인터넷을 연결하는것을 왠이
라고 부른다.

## Q3. 인터넷의 어원이라고 할수있는 인터네트워킹 이라는 용어는 무엇을 의미하는 용어일까요??
인터네트워킹은 네트워크와 네트워크를 서로 연결하는행위를 말한다.
이것을 전세계적으로 인터네트워킹한것을 인터넷이라고 부르기시작하였다.
